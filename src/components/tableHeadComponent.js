        ...
        <tr>
            ...
            columns.map((data, index) => (
              ...
              >
                  <div className="d-flex justify-content-between align-items-center">
                    ...
                    <div className="d-flex flex-column f-left">{data.replaceAll("_", " ")}</div>
          ...
          <th className="sc_cl_th text-center">
            ...
            <div className="d-flex align-items-center">
              ...
              <div className="d-flex col-11 flex-column text-center">Action</div>

              <div className="d-flex f-right flex-column">
                <MdKeyboardArrowUp
                  className="sc_cl_sortup sc_cl_visabilitynone"
                />
                <MdKeyboardArrowDown
                  className="sc_cl_sortdown sc_cl_visabilitynone"
                />
              </div>
