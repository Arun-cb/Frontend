...
const FnSideBar = ({
  ...
  return (
    <>
      ...
      <div className="nav-footer p-3 mt-auto" ref={BtnRef} id="nav-footer-content">
        <button
          className="sc_cl_nav_button gap-3 p-2"
          onClick={() => {
        ...
        >
          ...
          <span className="sc_cl_nav_link">KPI Activity Tracker</span>
        </button>
      </div>
    </>
  );
