/* ============================================================================================================================================================
   ...
   ** This Page is to define Reusable Area chart component   **
...
const FnAreaChartComponent = ({ kpi, min, max, id, kpiname, measure, target, updatedattributes, exportRestrict, frequency }) => {
  ...
  let fnGetChartAttributes = async () => {
    let res = await fetch(
      `${process.env.REACT_APP_SERVER_URL}/api/get_chart_attributes/${"area"}`,
      {
        method: "GET",
        headers: {
    ...
    let res_user = await fetch(
      `${process.env.REACT_APP_SERVER_URL}/api/get_chart_attributes/${user.user_id}/${"area"}`,
      {
        method: "GET",
        headers: {
          "Content-Type": "application/json",
  ...
  // console.log(cust_chartview,"cust")
  ...
  let intger_val = [
    cust_chartview.Areachart && cust_chartview.Areachart.margin,
    ...
    cust_chartview.area1 && cust_chartview.area1.style,
  ];
  ...
  useEffect(() => {
    ...
    // fnGetAttrDetails();
    // eslint-disable-next-Area react-hooks/exhaustive-deps
  }, []);
      ...
      <div className="bg-white sc_cl_chart_container rounded p-2">
        ...
        {cust_chartview.xaxis1 && (
          ...
          >
            <AreaChart
              data={kpi}
              margin={cust_chartview.Areachart.margin}
              ref={lineRef}
            >
              ...
              <text
                ...
                style={cust_chartview.area1.style}
              >
                {kpiname}
              </text>
              ...
              {(() => {
                if (legendShow) {
                  return (
                    ...
                    // <Legend align={cust_chartview.legend.align} />
                  )
                }
                else {
                  return (
              ...
              <Area
                ...
                dataKey="actuals"
                name="Actuals"
                stroke={cust_chartview.area1.stroke.color}
                fill={cust_chartview.area1.fill.color}
                activeDot={{ r: 8 }}
...
export default FnAreaChartComponent;
